...
const defualtFormStateReport = {
    message: null
}

const formStateSearch = reactive({ ...defualtFormStateSearch })
const formStateReport = reactive({ ...defualtFormStateReport })

// กำหนดฟังก์ชันโหลดข้อมูล
onLoadTable.value = async function loadTableData() {
    loading.value = true
    try {
        const params: SearchTableParams & SearchParams = {
            ...
            bankName: formStateSearch.bankName ,
...
const resetForm = () => {
    ...
    Object.assign(formStateReport , defualtFormStateReport)
    resetTable()
    onLoadTable.value()
}
            ...
            <a-card class="shadow-sm">
                <div class="header-content">
                    <div class="header-text">
                        <h1 class="header-title">รายงานธุรกรรม</h1>
                    </div>
                </div>
                ...
                <a-form :required-mark="false" autocomplete="off" layout="vertical" :model="formStateSearch"> 
                    <a-row :gutter="24">
                        ...
                        <a-col :lg="4" :md="12" :xs="24">
                            <a-form-item label="ประเภท" name="action">
                        ...
                        <a-col :lg="4" :md="12" :xs="24">
                            <a-form-item label="ชื่อบัญชี" name="bankName">
                                <a-input v-model:value="formStateSearch.bankName" placeholder="กรุณากรอกชื่อบัญชี" />
                            </a-form-item>
                        </a-col>
                        <a-col :span="24">
                            <a-space>
                        ...
                        <template v-if="column.key === 'more'">
                            <a-space>
                                <a-button 
                                    ...
                                    v-if="isInvildPermission('transactions.approve')"
                                >
                                    <div class="flex items-center gap-2" >
