# LUXPAY UI Components

ชุด UI Components ที่ออกแบบมาเฉพาะสำหรับ LUXPAY ด้วยธีมสีเหลืองที่สวยงามและทันสมัย

## Components

### ThunderCard
การ์ดที่สวยงามพร้อมธีม LUXPAY
```vue
...
### ThunderButton
ปุ่มที่ออกแบบมาเฉพาะสำหรับ LUXPAY
```vue
...
### ThunderInput
Input field ที่สวยงามพร้อมธีม LUXPAY
```vue
<ThunderInput 
  v-model="value" 
  label="ป้ายกำกับ" 
