...
const data = reactive({
    ...
    "data": {
        "status": "pending",
        "transactionId": "TRX-TEAMAB-1753454567-FadNp",
        "reference": "trx-001",
        "amount": 1,
        "depositAmount": 1.37,
        "qrcode": "00020101021229370016A000000677010111021308355660444105802TH530376454041.376304A3D8",
        "bank": {
...
<template>
    <a-card class="shadow-sm">
        ...
        <a-typography-title :level="4" style="margin-bottom: 6px;">Create Deposit</a-typography-title>
        <p class="text-gray-400"><span class="text-yellow-500 font-bold mr-[8px]">POST</span>{ endPoint } /api/v1/mc/payin</p>
        <p>สร้างรายการฝากเงิน</p>
