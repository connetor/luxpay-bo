# LUKPAY UI Components

ชุด UI Components ที่ออกแบบมาเฉพาะสำหรับ LUKPAY ด้วยธีมสีเหลืองที่สวยงามและทันสมัย

## Components

### ThunderCard
การ์ดที่สวยงามพร้อมธีม LUKPAY
```vue
...
### ThunderButton
ปุ่มที่ออกแบบมาเฉพาะสำหรับ LUKPAY
```vue
...
### ThunderInput
Input field ที่สวยงามพร้อมธีม LUKPAY
```vue
<ThunderInput 
  v-model="value" 
  label="ป้ายกำกับ" 
